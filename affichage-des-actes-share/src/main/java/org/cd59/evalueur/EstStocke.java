...
/**
 * Evaluateur permettant de savoir si un dossier est stocké.
 */
public class EstStocke extends BaseEvaluator {
    ...
    public boolean evaluate(JSONObject jsonObject) {
        ...
        try {
            ...
            throw new RuntimeException(
                    String.format("Une erreur est survenue lors de l'évaluation d'affichage de l'icône de " +
