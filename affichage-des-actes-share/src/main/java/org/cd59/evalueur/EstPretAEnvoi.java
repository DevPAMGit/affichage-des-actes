...
/**
 * Evaluateur permettant de savoir si un dossier est prêt à être envoyé.
 */
public class EstPretAEnvoi extends BaseEvaluator {
    ...
    public boolean evaluate(JSONObject jsonObject) {
        ...
        try {
            ...
            return (
                    (etatEnvoi != null && etatEnvoi.equals("Prêt à être envoyé")) &&
                    (etatStockage != null && etatStockage.equals("Stocké"))
            );
