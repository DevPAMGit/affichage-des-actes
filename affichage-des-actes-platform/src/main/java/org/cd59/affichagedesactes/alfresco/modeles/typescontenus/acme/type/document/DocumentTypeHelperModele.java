...
/** Classe modèle d'aide personnalisée pour le type de contenu {@link DocumentTypeHelperModele}.*/
public class DocumentTypeHelperModele extends AlfrescoModeleHelper {
	...
	public DocumentTypeHelperModele(ServiceRegistry serviceRegistry, NodeRef noeud){
	...
	public boolean hasAspect() { 
		return this.hasAspect(DocumentTypeModele.NOM);
	}

	/** Supprime un type de contenu du nœud. */
	public void supprimeAspect() { 
		this.supprimeAspect(this.noeud, DocumentTypeModele.NOM); 
	}
	...
	public void addAspect(Map<QName,Serializable> valeurs) {
		this.addAspect(this.noeud, DocumentTypeModele.NOM, valeurs);
	}
	...
	*/
	public void addType(){
		this.addType(DocumentTypeModele.NOM);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'acme:documentId'. 
	 * @return String La valeur de la propriété 'acme:documentId'. */
	public String getDocumentId() { 
		return (String) this.getPropriete(DocumentTypeModele.DOCUMENT_ID);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'acme:documentId'. 
	 * @param valeur La nouvelle valeur de la propriété 'acme:documentId'. */ 
	public void setDocumentId(String valeur) { 
		this.majPropriete(DocumentTypeModele.DOCUMENT_ID, valeur);
	}
	...
	public String getSecurityClassification() { 
		return (String) this.getPropriete(DocumentTypeModele.SECURITY_CLASSIFICATION);
	}
	...
	public void setSecurityClassification(String valeur) { 
		this.majPropriete(DocumentTypeModele.SECURITY_CLASSIFICATION, valeur);
	}
