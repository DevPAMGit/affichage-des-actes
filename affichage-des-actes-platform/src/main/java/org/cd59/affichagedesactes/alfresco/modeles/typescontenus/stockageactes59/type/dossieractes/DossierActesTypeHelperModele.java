...
public class DossierActesTypeHelperModele extends AlfrescoModeleHelper {
	...
	*/
	...
	public int getNbActes() { 
		return (int) this.getPropriete(DossierActesTypeModele.NB_ACTES);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:nbActes'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:nbActes'. */ 
	public void setNbActes(int valeur) { 
		this.majPropriete(DossierActesTypeModele.NB_ACTES, valeur);
	}
	...
	public int getNbActesEnErreurs() { 
		return (int) this.getPropriete(DossierActesTypeModele.NB_ACTES_EN_ERREURS);
	}
	...
	public void setNbActesEnErreurs(int valeur) { 
		this.majPropriete(DossierActesTypeModele.NB_ACTES_EN_ERREURS, valeur);
	}
	...
	public int getNbActesTraites() { 
		return (int) this.getPropriete(DossierActesTypeModele.NB_ACTES_TRAITES);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:nbActesTraites'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:nbActesTraites'. */ 
	public void setNbActesTraites(int valeur) { 
		this.majPropriete(DossierActesTypeModele.NB_ACTES_TRAITES, valeur);
	}
	...
	/** Méthode permettant de vérifier la validité de le type de contenu 'stockageactes59:dossierActes'. 
