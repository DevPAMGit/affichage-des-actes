...
/** Classe modèle d'aide personnalisée pour le type de contenu {@link StockageFichierTypeHelperModele}.*/
public class StockageFichierTypeHelperModele extends AlfrescoModeleHelper {

	/** Initialise une nouvelle instance de la classe {@link StockageFichierTypeHelperModele}. 
	 * @param serviceNoeud Le service de gestion des nœuds d'Alfresco. 
	 * @param noeud Le nœud de référence. */
	public StockageFichierTypeHelperModele(NodeService serviceNoeud, NodeRef noeud){
	...
	public boolean hasAspect() { 
		return this.hasAspect(StockageFichierTypeModele.NOM);
	}

	/** Supprime un type de contenu du nœud. */
	public void supprimeAspect() { 
		this.supprimeAspect(this.noeud, StockageFichierTypeModele.NOM); 
	}
	...
	public void addAspect(Map<QName,Serializable> valeurs) {
		this.addAspect(this.noeud, StockageFichierTypeModele.NOM, valeurs);
	}
	...
	*/
	public boolean hasType() {
		return this.hasType(StockageFichierTypeModele.NOM);
	}
	...
	*/
	public void addType(){
		this.addType(StockageFichierTypeModele.NOM);
	}
	...
	public String getTypeFichier() { 
		return (String) this.getPropriete(StockageFichierTypeModele.TYPE_FICHIER);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:typeFichier'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:typeFichier'. */ 
	public void setTypeFichier(String valeur) { 
		this.majPropriete(StockageFichierTypeModele.TYPE_FICHIER, valeur);
	}
	...
	public String getEmpreinteFichier() { 
		return (String) this.getPropriete(StockageFichierTypeModele.EMPREINTE_FICHIER);
	}
	...
	public void setEmpreinteFichier(String valeur) { 
		this.majPropriete(StockageFichierTypeModele.EMPREINTE_FICHIER, valeur);
	}
	...
	/** Méthode permettant de vérifier la validité de le type de contenu 'stockageactes59:stockageFichier'. 
