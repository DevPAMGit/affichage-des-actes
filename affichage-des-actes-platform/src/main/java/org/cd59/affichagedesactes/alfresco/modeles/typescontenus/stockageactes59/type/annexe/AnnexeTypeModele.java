...
/** Classe modèle personnalisée pour le type de contenu {@link AnnexeTypeModele}. */
public class AnnexeTypeModele {
	...
	public final static QName NOM = QName.createQName( URI , "annexe");
