package org.cd59.affichagedesactes.alfresco.modeles.sources;
...
public class AlfrescoModeleHelper extends AlfrescoHelper {
	...
	* @return La liste des nœuds contenue dans le nœud. */
	...
	public NodeRef creerDossier(String nom) {
		NodeRef resultat = this.searchNoeudDossierParNom(this.noeud, ContentModel.TYPE_FOLDER, nom);
		if( resultat == null )
			resultat = this.serviceNoeud.createNode(this.noeud, ContentModel.ASSOC_CONTAINS, QName.createQName(nom),
