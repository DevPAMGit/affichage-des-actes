package org.cd59.affichagedesactes.alfresco.modeles.typescontenus.stockageactes59.type.conteneuracteannee ;
...
/** Classe modèle d'aide personnalisée pour le type de contenu {@link ConteneurActeAnneeTypeHelperModele}.*/
public class ConteneurActeAnneeTypeHelperModele extends AlfrescoModeleHelper {

	/** Initialise une nouvelle instance de la classe {@link ConteneurActeAnneeTypeHelperModele}. 
	 * @param serviceNoeud Le service de gestion des nœuds d'Alfresco. 
	 * @param noeud Le nœud de référence. */
	public ConteneurActeAnneeTypeHelperModele(NodeService serviceNoeud, NodeRef noeud){
	...
	public boolean hasAspect() { 
		return this.hasAspect(ConteneurActeAnneeTypeModele.NOM);
	}

	/** Supprime un type de contenu du nœud. */
	public void supprimeAspect() { 
		this.supprimeAspect(this.noeud, ConteneurActeAnneeTypeModele.NOM); 
	}
	...
	public void addAspect(Map<QName,Serializable> valeurs) {
		this.addAspect(this.noeud, ConteneurActeAnneeTypeModele.NOM, valeurs);
	}
	...
	*/
	public boolean hasType() {
		return this.hasType(ConteneurActeAnneeTypeModele.NOM);
	}
	...
	*/
	public void addType(){
		this.addType(ConteneurActeAnneeTypeModele.NOM);
	}
	...
	public int getDateAnnee() { 
		return (int) this.getPropriete(ConteneurActeAnneeTypeModele.DATE_ANNEE);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:dateAnnee'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:dateAnnee'. */ 
	public void setDateAnnee(int valeur) { 
		this.majPropriete(ConteneurActeAnneeTypeModele.DATE_ANNEE, valeur);
	}
	...
	/** Méthode permettant de vérifier la validité de le type de contenu 'stockageactes59:conteneurActeAnnee'. 
