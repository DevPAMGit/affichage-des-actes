...
/** Classe modèle d'aide personnalisée pour le type de contenu {@link DossierMoisTypeHelperModele}.*/
public class DossierMoisTypeHelperModele extends AlfrescoModeleHelper {

	/** Initialise une nouvelle instance de la classe {@link DossierMoisTypeHelperModele}. 
	 * @param serviceRegistry Le registre des services. 
	 * @param noeud Le nœud de référence. */
	public DossierMoisTypeHelperModele(ServiceRegistry serviceRegistry, NodeRef noeud){
	...
	public boolean hasAspect() { 
		return this.hasAspect(DossierMoisTypeModele.NOM);
	}

	/** Supprime un type de contenu du nœud. */
	public void supprimeAspect() { 
		this.supprimeAspect(this.noeud, DossierMoisTypeModele.NOM); 
	}
	...
	public void addAspect(Map<QName,Serializable> valeurs) {
		this.addAspect(this.noeud, DossierMoisTypeModele.NOM, valeurs);
	}
	...
	*/
	public boolean hasType() {
		return this.hasType(DossierMoisTypeModele.NOM);
	}
	...
	*/
	public void addType(){
		this.addType(DossierMoisTypeModele.NOM);
	}
	...
	public int getMois() { 
		return (int) this.getPropriete(DossierMoisTypeModele.MOIS);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:mois'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:mois'. */ 
	public void setMois(int valeur) { 
		this.majPropriete(DossierMoisTypeModele.MOIS, valeur);
	}
	...
	public int getAnnee() { 
		return (int) this.getPropriete(DossierMoisTypeModele.ANNEE);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:annee'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:annee'. */ 
	public void setAnnee(int valeur) { 
		this.majPropriete(DossierMoisTypeModele.ANNEE, valeur);
	}
	...
	/** Méthode permettant de vérifier la validité de le type de contenu 'stockageactes59:dossierMois'. 
