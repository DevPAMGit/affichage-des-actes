...
/** Classe modèle personnalisée pour le type de contenu {@link FichierTypeModele}. */
public class FichierTypeModele {
	...
	public final static QName NOM = QName.createQName( URI , "fichier");
