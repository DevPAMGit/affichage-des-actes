package org.cd59.affichagedesactes.alfresco.modeles.typescontenus.stockageactes59.type.stockageacteoriginal ;
...
/** Classe modèle d'aide personnalisée pour le type de contenu {@link StockageActeOriginalTypeHelperModele}.*/
public class StockageActeOriginalTypeHelperModele extends AlfrescoModeleHelper {

	/** Initialise une nouvelle instance de la classe {@link StockageActeOriginalTypeHelperModele}. 
	 * @param serviceNoeud Le service de gestion des nœuds d'Alfresco. 
	 * @param noeud Le nœud de référence. */
	public StockageActeOriginalTypeHelperModele(NodeService serviceNoeud, NodeRef noeud){
	...
	public boolean hasAspect() { 
		return this.hasAspect(StockageActeOriginalTypeModele.NOM);
	}

	/** Supprime un type de contenu du nœud. */
	public void supprimeAspect() { 
		this.supprimeAspect(this.noeud, StockageActeOriginalTypeModele.NOM); 
	}
	...
	public void addAspect(Map<QName,Serializable> valeurs) {
		this.addAspect(this.noeud, StockageActeOriginalTypeModele.NOM, valeurs);
	}
	...
	*/
	public boolean hasType() {
		return this.hasType(StockageActeOriginalTypeModele.NOM);
	}
	...
	*/
	public void addType(){
		this.addType(StockageActeOriginalTypeModele.NOM);
	}
	...
	public String getTypeFichier() { 
		return (String) this.getPropriete(StockageActeOriginalTypeModele.TYPE_FICHIER);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:typeFichier'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:typeFichier'. */ 
	public void setTypeFichier(String valeur) { 
		this.majPropriete(StockageActeOriginalTypeModele.TYPE_FICHIER, valeur);
	}
	...
	public String getEmpreinteFichier() { 
		return (String) this.getPropriete(StockageActeOriginalTypeModele.EMPREINTE_FICHIER);
	}
	...
	public void setEmpreinteFichier(String valeur) { 
		this.majPropriete(StockageActeOriginalTypeModele.EMPREINTE_FICHIER, valeur);
	}
	...
	/** Méthode permettant de vérifier la validité de le type de contenu 'stockageactes59:stockageActeOriginal'. 
