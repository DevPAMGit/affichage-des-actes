package org.cd59.affichagedesactes.alfresco.modeles.typescontenus.stockageactes59.type.conteneuractemois ;
...
/** Classe modèle d'aide personnalisée pour le type de contenu {@link ConteneurActeMoisTypeHelperModele}.*/
public class ConteneurActeMoisTypeHelperModele extends AlfrescoModeleHelper {

	/** Initialise une nouvelle instance de la classe {@link ConteneurActeMoisTypeHelperModele}. 
	 * @param serviceNoeud Le service de gestion des nœuds d'Alfresco. 
	 * @param noeud Le nœud de référence. */
	public ConteneurActeMoisTypeHelperModele(NodeService serviceNoeud, NodeRef noeud){
	...
	public boolean hasAspect() { 
		return this.hasAspect(ConteneurActeMoisTypeModele.NOM);
	}

	/** Supprime un type de contenu du nœud. */
	public void supprimeAspect() { 
		this.supprimeAspect(this.noeud, ConteneurActeMoisTypeModele.NOM); 
	}
	...
	public void addAspect(Map<QName,Serializable> valeurs) {
		this.addAspect(this.noeud, ConteneurActeMoisTypeModele.NOM, valeurs);
	}
	...
	*/
	public boolean hasType() {
		return this.hasType(ConteneurActeMoisTypeModele.NOM);
	}
	...
	*/
	public void addType(){
		this.addType(ConteneurActeMoisTypeModele.NOM);
	}
	...
	public int getDateMois() { 
		return (int) this.getPropriete(ConteneurActeMoisTypeModele.DATE_MOIS);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:dateMois'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:dateMois'. */ 
	public void setDateMois(int valeur) { 
		this.majPropriete(ConteneurActeMoisTypeModele.DATE_MOIS, valeur);
	}
	...
	public int getDateAnnee() { 
		return (int) this.getPropriete(ConteneurActeMoisTypeModele.DATE_ANNEE);
	}

	/** Méthode permettant de récupérer la valeur de la propriété 'stockageactes59:dateAnnee'. 
	 * @param valeur La nouvelle valeur de la propriété 'stockageactes59:dateAnnee'. */ 
	public void setDateAnnee(int valeur) { 
		this.majPropriete(ConteneurActeMoisTypeModele.DATE_ANNEE, valeur);
	}
	...
	/** Méthode permettant de vérifier la validité de le type de contenu 'stockageactes59:conteneurActeMois'. 
