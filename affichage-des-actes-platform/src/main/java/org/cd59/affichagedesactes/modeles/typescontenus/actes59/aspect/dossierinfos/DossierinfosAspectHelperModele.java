package org.cd59.affichagedesactes.modeles.typescontenus.actes59.aspect.dossierinfos ;
...
public class DossierinfosAspectHelperModele extends AlfrescoModeleHelper {
	...
	/** Méthode permettant de vérifier si la valeur de la propriété 'actes59:source' est valide. 
	 * @return <c>true</c> si la valeur est valide; sinon <c>false</c>'.  */
	...
	/** Méthode permettant de vérifier si la valeur de la propriété 'actes59:annee' est valide. 
	 * @return <c>true</c> si la valeur est valide; sinon <c>false</c>'.  */
	...
	/** Méthode permettant de vérifier si la valeur de la propriété 'actes59:numeroacte' est valide. 
	 * @return <c>true</c> si la valeur est valide; sinon <c>false</c>'.  */
	...
	/** Méthode permettant de vérifier si la valeur de la propriété 'actes59:iddossier' est valide. 
	 * @return <c>true</c> si la valeur est valide; sinon <c>false</c>'.  */
