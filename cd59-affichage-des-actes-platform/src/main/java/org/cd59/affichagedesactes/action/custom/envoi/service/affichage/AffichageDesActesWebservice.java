package org.cd59.affichagedesactes.action.custom.envoi.service.affichage;


import org.cd59.affichagedesactes.action.custom.envoi.service.affichage.services.EnvoiActeService;
import org.cd59.affichagedesactes.action.custom.envoi.service.affichage.services.LoginCheckService;
import org.cd59.affichagedesactes.action.custom.envoi.service.affichage.services.exception.ServiceException;
...
/**
 * Classe permettant d'attaquer les webservices pour l'affichage des actes.
 */
public class AffichageDesActesWebservice {
    ...
    public String envoyerActe(String nomUtilisateur, String motDePasse, EnvoiActeFichierModel acte,
                              EnvoiActeFichierModel annexe, JSONObject metadonnees)
